...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
		KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,          KC_J,    KC_L,    KC_U,    KC_Y,    TD(CQT), KC_LBRC, KC_RBRC,
		KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,          KC_K,    KC_N,    KC_E,    KC_I,    KC_O,         KC_ENT,
		KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,          KC_SLSH, KC_M,    KC_H,    TD(CMN), KC_DOT,  KC_MINS, KC_RSPC,
		KC_LCTL, KC_LGUI,                   KC_LALT, KC_SPC,	      KC_BSPC, TD(LYR),                            KC_RALT, KC_RCTL
    ),
    ...
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,          KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, _______,
  	...
  	_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,        KC_F12,  KC_INS,  KC_DEL,  KC_PGUP, KC_PGDN, _______, _______,
  	_______, _______,                   _______, _______,	      _______, _______,                            _______, _______
    ),

    [_SYMBL2] = LAYOUT(
    KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______,
    KC_TILD, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,       XXXXXXX, KC_PIPE, KC_PLUS, KC_LCBR, KC_RCBR,      KC_MPLY,
    _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, XXXXXXX,       XXXXXXX, KC_PSCR, KC_PAUS, KC_HOME, KC_END,  _______, _______,
    _______, _______,                   _______, _______,	      _______, _______,                            _______, _______
    ),
