 ...
 */
  [_COLEMAK] = LAYOUT(
    ...
    SC_LSPO, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_SLSH, KC_M,    KC_H,    TD(CMN), KC_DOT,  SC_RSPC,
 ...
 * └──────┘-----└──────┴──────────────┴─────┴──────────────┴──────┘-----└──────┘
 */
  [_SYMBOL] = LAYOUT( /* Symbol Keys, Media and other Keys */
 ...
 * └──────┘-----└──────┴──────────────┴─────┴──────────────┴──────┘-----└──────┘
 */
  [_SYMBL2] = LAYOUT( /* Shifted Symbol, F-Keys */
 ...
 * └──────┘-----└──────┴──────────────┴─────┴──────────────┴──────┘-----└──────┘
 */
  [_ADJUST] = LAYOUT( /* Board Functions */
    QK_BOOT, QWERTY,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
void layers_per_tap(tap_dance_state_t *state, void *user_data) {
  if (state->count == 1) {
...
void tabesc_per_tap(tap_dance_state_t *state, void *user_data) {
  if (state->count > 1) {
