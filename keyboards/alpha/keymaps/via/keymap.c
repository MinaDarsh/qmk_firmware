...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		MC_REIN, MC_WSTW, MC_WATC, MC_WGRN, MC_WEAT, MC_WRCR, MC_WSPR, MC_WFLT, KC_UP,   MC_PSHG,
		MC_SPLY, MC_SEAF, MC_EAIR, MC_OPRS, MC_OGTB, MC_OLSR, MC_ORCS, KC_LEFT, KC_DOWN, KC_RGHT,
				 MC_ERAR, MC_ESTR, MC_ECLB, MC_E110, KC_LCTL, MC_E500, MC_DEMS, MC_EXOS)
};
