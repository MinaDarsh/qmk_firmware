...
/* Colemak-DHk
 * ┌─────┐  ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
 * │  1  │  │Tb/Es│  Q  │  W  │  F  │  P  │  B  │  J  │  L  │  U  │  Y  │'(;) │ Del │
 * ├─────┤  ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
 * │  2  │  │BkSpc│  A  │  R  │  S  │  T  │  G  │  K  │  N  │  E  │  I  │  O  │Enter│
 * ├─────┤  ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
 * │  3  │  │LShft│  Z  │  X  │  C  │  D  │  V  │  M  │  H  │,(-) │  .  │  /  │RShft│
 * ├─────┤  ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
 * │  4  │  │LCtl │ App │ GUI │LAlt │Lower│Space┋Space│Raise│Left │Down │ Up  │Right│
 * └─────┘  └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
 */
[_COLEMAK] = LAYOUT(
    KC_1,   TD(TES), KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,    TD(CQT), KC_DEL,
    KC_2,   KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_K,    KC_N,    KC_E,    KC_I,    KC_O,    KC_ENT,
    KC_3,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_M,    KC_H,    TD(CMN), KC_DOT,  KC_SLSH, KC_RSFT,
    KC_4,    KC_LCTL, KC_APP,  KC_LGUI, KC_LALT, LOWER,       KC_SPC,       RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 */
[_GAMING] = LAYOUT(
    _______,   TD(GES), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    _______,   _______, XXXXXXX, XXXXXXX, _______, _______,      _______,     _______, _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT(
    ...
    _______,   _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_BSLS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
    _______,   _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______,
